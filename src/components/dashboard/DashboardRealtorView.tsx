        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          ...
          <div className="glass-card" style={{ padding: '1.75rem', background: '#FFFFFF' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem', fontSize: '0.86rem', color: 'var(--text-muted)' }}>
              ...
              <div>
                <strong style={{ color: 'var(--text-main)' }}>2. Фиксируйте прямой тариф EVN за свет:</strong>
                <div>Государственный тариф — около 2800–3200 ₫/кВт. Если собственник называет 4000–5000 ₫ — это переплата до $50-$80 в месяц за кондиционеры.</div>
              </div>
              <div>
