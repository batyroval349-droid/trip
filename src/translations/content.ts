...
export const UI_STRINGS = {
  en: {
    ...
    processBadge: 'Transparent Process & Financial Shield',
    processTitle: 'From Intake to Keys in Hand: 4-Step Process & Financial Risk Shield',
    ...
    processStep3Title: 'Technical Audit & Contract Review',
    processStep3Desc: 'We verify peak-hour Wi-Fi Speedtest, check active construction permits within 100 meters, and vet the lease: locking official EVN power rates and deposit return terms.',
    processStep3Result: 'Legally safe bilingual lease (VN/EN) with complete security deposit protection.',
    processStep3Risk: 'Eliminates: $400–$900 deposit forfeiture & jackhammers at 6:30 AM',
    ...
    shieldBadge: 'ROI & Safety Economics',
    shieldTitle: 'The Real Cost of Moving Solo: Cost of Mistakes vs Concierge Protection',
    shieldIntro: 'Statistics show 7 out of 10 expats lose between $800 and $1,800 on their first Vietnam lease due to lack of local oversight. With us, these risks drop to zero.',
    ...
    shieldRisk1Shield: 'Bilingual lease (VN/EN) + photographic handover inventory upon arrival.',
    ...
    shieldRisk3Title: 'Hidden Construction or Monsoon',
    ...
    shieldRisk3Shield: 'Acoustic neighborhood audit and safe location matching by season.',
    ...
    shieldCTA: 'Select Relocation Package ($490) →',
  ...
  ru: {
    ...
    processBadge: 'Прозрачный процесс и финансовый щит',
    ...
    processStep3Title: 'Технический фильтр и экспертиза договора',
    processStep3Desc: 'Проверяем Speedtest Wi-Fi в часы пик, карту строек в радиусе 100 метров и выверяем договор: фиксируем государственные тарифы на свет и условия возврата залога при выезде.',
    processStep3Result: 'Безопасный двуязычный контракт (VN/EN) с юридической защитой вашего депозита.',
    processStep3Risk: 'Исключает: потерю депозита ($400–$900) и шум стройки в 6 утра',
    ...
    shieldBadge: 'Математика безопасности',
    shieldTitle: 'Сколько стоит самостоятельный переезд: цена ошибок vs Сопровождение',
    shieldIntro: 'По статистике 7 из 10 экспатов при первой аренде во Вьетнаме теряют от $800 до $1,800 из-за отсутствия местного контроля. С нами эти риски равны нулю.',
    ...
    shieldRisk1Shield: 'Двуязычный договор (VN/EN) + акт фотофиксации при заезде.',
    ...
    shieldRisk3Title: 'Скрытая стройка или сезон дождей',
    shieldRisk3Cost: '-$400 ... -$800',
    ...
    shieldRisk3Shield: 'Акустический аудит окружения и подбор безопасных районов под сезон.',
    ...
    shieldCTA: 'Выбрать тариф «Планирование релокации» ($490) →',
