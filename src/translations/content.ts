...
export const UI_STRINGS = {
  en: {
    ...
    tier1Desc: '40-minute strategic consultation: evaluate whether moving to Vietnam fits your goals, city selection, answers to key questions.',
    ...
    tier2Feat5: '1 complimentary itinerary revision',
    tier2Feat6: 'Emergency contacts list (embassy, ambulance, 911 equivalent)',

    tier3Title: 'Relocation Planning',
    tier3Price: '$490',
    ...
    tier3Feat4: 'Chat-based guidance & support — 1 month',
  ...
  ru: {
    ...
    tier1Desc: '40-минутная стратегическая консультация: оценка целесообразности переезда под ваши цели, выбор городов, ответы на главные вопросы.',
    ...
    tier1Feat5: 'Скидка на пакет планирования поездки или релокации при покупке в течение 7 дней после звонка',

    tier2Title: 'Планирование поездки',
    tier2Price: '$290',
    tier2Badge: null,
    ...
    tier2Feat5: '1 бесплатная корректировка маршрута',
    tier2Feat6: 'Список экстренных контактов (посольство, скорая, аналог 911)',

    tier3Title: 'Планирование релокации',
    tier3Price: '$490',
    tier3Badge: 'Самый Популярный',
    tier3Desc: 'Пошаговый план переезда под ваш бюджет и профиль — вместо недель гугления форумов и групп.',
    ...
    tier3Feat4: 'Сопровождение в переписке — 1 месяц',
    ...
    tier4Feat2: 'Приоритетная связь в WhatsApp/Telegram',
    tier4Feat3: 'Личное сопровождение показов жилья через нашего партнёра-риелтора',
    tier4Feat4: '1 месяц сопровождения по бюджету после прилёта',
