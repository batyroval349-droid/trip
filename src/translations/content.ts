  ...
  verifiedHousing: [
    {
      ...
      founderReview: {
        ...
        ru: 'ЖК японского стандарта качества. Редкий случай прямого тарифа EVN и настоящей шумоизоляции в Дананге. Идеально для комфортной удаленной работы.'
      },
...
export const UI_STRINGS = {
  en: {
    ...
    processStep3Title: 'Lease Agreement, Terms & Hidden Cost Audit',
    processStep3Desc: 'We audit your lease before signing: eliminating hidden building fees, locking agreed electricity and water rates, and securing clear deposit return terms and timelines. We provide a landlord checklist covering Wi-Fi specs and house rules.',
    processStep3Result: 'Clear bilingual lease terms and predictable living expenses without unexpected surprises.',
    processStep3Risk: 'Mitigates: deposit forfeiture upon move-out, unexpected utility rate hikes, and landlord disputes',
    processStep4Badge: 'Arrival Day',
    processStep4Title: 'Move-in Guide, Essential Contacts & 30-Day Support',
    processStep4Desc: 'We provide a straightforward move-in inspection guide (photo documentation of meters and furniture to protect your deposit), a ready-to-send message template for your host regarding police registration (tạm trú), verified scooter rentals without passport retention, and 30 days of direct chat support.',
    processStep4Result: 'Deposit protection guide, landlord registration template, verified local contacts, and direct founder chat support.',
    processStep4Risk: 'Eliminates: unfair move-out damage claims, registration confusion, and initial settling stress',
    ...
    shieldRisk2Title: 'Unexpected Utility & Electricity Overcharges',
    shieldRisk2Cost: '-$150 ... -$250 / 6 mo',
    shieldRisk2Desc: 'Inflated baseline meter readings or unannounced electricity and water rate hikes mid-lease.',
    shieldRisk2Shield: 'Fixing initial baseline meter readings and agreed utility rates in the lease.',
    shieldRisk3Title: 'Monsoon Season, Dampness & Risky Areas',
    shieldRisk3Cost: '-$400 ... -$800',
    shieldRisk3Desc: 'Renting in a problematic neighborhood or off-season (dampness, morning construction). Forced relocation and lost deposit.',
    shieldRisk3Shield: 'Season-matched neighborhood selection and home inspection checklist before booking.',
  ...
  ru: {
    ...
    processStep3Title: 'Проверка договора, условий аренды и скрытых платежей',
    processStep3Desc: 'Проверяем договор аренды перед подписанием: исключаем скрытые комиссии за обслуживание дома, фиксируем тарифы на электричество и воду, закрепляем точные сроки и условия возврата залога. Даем чек-лист вопросов владельцу по интернету и правилам проживания.',
    processStep3Result: 'Понятный двуязычный договор с прозрачными условиями и предсказуемые расходы на проживание.',
    processStep3Risk: 'Предотвращает: невозврат депозита при выезде, внезапные накрутки на коммуналку и спорные ситуации с хозяином',
    ...
    shieldRisk2Title: 'Скрытые накрутки на свет и коммуналку',
    shieldRisk2Cost: '-$150 ... -$250 / полгода',
    shieldRisk2Desc: 'Списание завышенных начальных показаний счетчиков или внезапное повышение тарифа на свет и воду посреди срока аренды.',
    shieldRisk2Shield: 'Фиксация начальных показаний счётчиков и фиксированного тарифа в договоре.',
    shieldRisk3Title: 'Сезон дождей, сырость и шумные районы',
    shieldRisk3Cost: '-$400 ... -$800',
    shieldRisk3Desc: 'Аренда жилья в неудачном районе или в несезон (сырость, шум строек под окнами). Вынужденный съезд и потеря депозита.',
    shieldRisk3Shield: 'Подбор проверенных районов под сезон и чек-лист для проверки жилья перед бронью.',
